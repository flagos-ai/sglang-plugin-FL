...
#
# SGLang's fused-op OOT registry (or the legacy AROUND hook) calls bridge
# functions which handle framework-specific parameters (post_residual_addition,
# fused_set_kv_buffer_arg, etc.), then call dispatch.call_op() with the
