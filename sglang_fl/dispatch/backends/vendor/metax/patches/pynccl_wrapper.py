...
from sglang.srt.distributed.device_communicators.pynccl_wrapper import ncclUniqueId, ncclDataTypeEnum, ncclRedOpTypeEnum
...
def patch_pynccl_wrapper() -> None:
    """Replace selected classes in sglang.srt.layers.attention.flashinfer_backend."""
    module_name = "sglang.srt.distributed.device_communicators.pynccl_wrapper"
    ...
    module.NCCLLibrary = NCCLLibrary
    logger.info(
        "patched NCCLLibrary"
    )
