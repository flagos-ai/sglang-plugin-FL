...
def _patch_fused_moe_functions() -> None:
    """Patch SGLang fused_moe helpers for MetaX.

    Keep this as a small wrapper layer around the original SGLang functions:
    put MetaX-specific argument fixes or launch-parameter changes in the
    wrappers below, then delegate to the saved original implementation.
    """
