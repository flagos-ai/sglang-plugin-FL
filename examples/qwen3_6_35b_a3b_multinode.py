...
Validates that sglang-plugin-FL serves Qwen3.6-35B-A3B across two nodes and runs
text, concurrent, multimodal (VL), and high-concurrency inference tests. The
default TP=2/PP=2 layout places one TP group on each node and sends pipeline
